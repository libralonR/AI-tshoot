...
Mantém os mesmos nomes da versão atual (`observa_*`) para que dashboards e
alertas funcionem sem alteração.
"""

from prometheus_client import Counter, Gauge, Histogram, Info

APP_INFO = Info("observa", "Observability Troubleshooting Copilot")
APP_INFO.info({"version": "1.1.0-hex", "service": "orchestrator"})
