"""Adapter Incidents PG → IncidentSource.

Substitui o `agents/incidents.py` da versão atual.
"""
...
class PgIncidentAdapter:
    """IncidentSource implementation backed by Incidents PG MCP."""
