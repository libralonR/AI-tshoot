"""Adapter Grafana → AlertSource.

Substitui o `agents/grafana.py` da versão atual. Mesma lógica, apenas
implementa o Protocol `AlertSource` formalmente.
"""
...
from domain.models import Evidence, EvidenceType, Scope
...
class GrafanaAlertAdapter:
    """AlertSource implementation backed by Grafana MCP."""
