...
Cópia literal do `orchestrator/guardrails.py` ajustada apenas para os imports
do novo módulo de domínio. Não introduz I/O nem dependências externas.
"""
...
from domain.models import Evidence, NextStep
