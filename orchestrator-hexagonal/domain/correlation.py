"""Motor de correlação de sinais por labels canônicas.

Lógica idêntica à versão atual em `orchestrator/correlation.py`.
Domínio puro: depende apenas de `domain.models`.
"""

import logging
from typing import Any, Dict, List, Optional, Tuple

from domain.models import CorrelationGap, Evidence, Scope
